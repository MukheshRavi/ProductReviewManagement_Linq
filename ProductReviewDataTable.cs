...
namespace ProductReviewManagement
{
    class ProductReviewDataTable
    {
        ...
        {   
            ...
            {
                Console.WriteLine("Product ID: " + productReview.Field<string>("ProductID") + " UserID: " + 
                    productReview.Field<string>("UserID") + " Rating: " + productReview.Field<string>("Rating") + " Review: " 
                    + productReview.Field<string>("Review") + " IsLike: " + productReview.Field<string>("IsLike"));
            }
        }
        /// <summary>
        /// UC 10: 
